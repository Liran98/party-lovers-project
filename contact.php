...
if (isset($_POST['submit'])) {
  ...
  try {
    ...
    $mail->SMTPAuth   = $_ENV['MAIL_AUTH'];                                   //Enable SMTP authentication
    ...
    $mail->addAddress('party_lovers1@yahoo.com', 'Party Lovers Officials');     //Add a recipient
    ...
    $mail->send();
    $msg = 'Message has been sent, we will be in touch with you';
  } catch (Exception $e) {
            ...
            <div class="card-body p-0">
              <div class="row gy-3 gy-md-4 gy-lg-0">
                ...
                <div class="col-12 col-lg-6">
                  <?php echo "<p style='color:lightgreen' class='text-center'>$msg</p>"; ?>
                    ...
                    <div class="col-12">
                      ...
                      <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                        <div class="col-12">
                          ...
                          <input type="text" class="form-control" id="fullname" name="fullname" value="123" required>
                        </div>
                        <div class="col-12 col-md-6">
                          ...
                          <div class="input-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" value="123@gmail.com" required>
                          </div>
                        </div>
                        <div class="col-12 col-md-6">
                          ...
                          <div class="input-group">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" value="123">
                          </div>
                        </div>
                        <div class="col-12">
                          <label for="subject" class="form-label">Subject <span class="text-danger">*</span></label>
                          <input type="text" class="form-control" id="subject" name="subject" value="123" required>
                        </div>
                        <div class="col-12">
                          <label for="message" class="form-label">Message <span class="text-danger">*</span></label>
                          <textarea class="form-control" id="message" name="message" rows="3" required>123</textarea>
                        </div>
                        <div class="col-12">
                          <div class="d-grid">
                            <button class="btn btn-primary btn-lg send_message" name="submit" type="submit">Send Message</button>
                          </div>
                        </div>
                      </div>
                    </div>
