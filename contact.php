                    ...
                    <div class="col-12">
                      <form action="#!">
                        <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                          ...
                          <div class="col-12">
                            <div class="d-grid">
                              <button class="btn btn-primary btn-lg" name="submit" type="submit">Send Message</button>
                            </div>
                          </div>
                        </div>
                      </form>
...
if (isset($_POST['submit'])) {
  ...
  try {
      ...
      $mail->Username   = '9d85261c0a2096';                     //SMTP username
      $mail->Password   = '42902565944de7';                               //SMTP password
